...
<?
	echo "<div class='btn_pagina'>
			<div class='btn_cadastro'>
				<a href='cad.php'><p>Cadastar Banner</p></a>
			</div>    
		</div>";

	echo "<div class='topo_pagina'>
			<div class='titulo_pagina'> Banners cadastrados </div>    
		</div>";
...
else
{
	...
	while ($linha2=mysql_fetch_array($resultado)) {
		...
		$id = $linha2["id"];
		$foto = $linha2["imagem"];
		if($foto == ''){$foto = '../images/sem_imagem.jpg';}else { $foto = '../banner/'.$foto; }
		...
		echo "<div class='item' style='background-color:$color; cursor:default' onMouseOver=\"javascript:this.style.backgroundColor='#EFEFEF'\" onMouseOut=\"javascript:this.style.backgroundColor='$color'\">
				<div class='itemfoto'><img src='$foto' width='250' height='70'/></div>    
...
//	    
	//			<div class='itemexcluir'> <a href=\"('')\"><img border=\"0\" src=\"img/btn_excluir.png\"> </div>
		@$colorcount++;
	}
}
