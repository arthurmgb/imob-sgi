...
?> <link rel="stylesheet" type="text/css" href="../../css/pagina_google.css"> <?	
	...
	$query = "UPDATE $banco SET codigomaps='".$_POST['codigomaps']."'";								
...
<?
	...
	echo "<div class='topo_pagina'>
			<div class='titulo_pagina'>Google Maps</div>    
		</div>";
	...
	echo "<form id='formcadastro' name='formcadastro' method='POST' action='cad.php?acao=alt' enctype='multipart/form-data'>";		
	 ...
	 echo "<div class='formulario'>
			...
			<div class='titulo1_formulario'><p>CONFIGURANDO GOOGLE MAPS</p><br>
			
			<p>Para exibir seus imóveis no mapa você precisa se cadastrar no GOOGLE MAPs. Para se cadastrar acesse o link: http://code.google.com/intl/pt-BR/apis/maps/signup.html</p></div>			
		</div>";	
            
     echo "<div class='formulario'>
	 
			<div class='titulo1_formulario'><p>Chave do google maps</p></div>
			<div class='item1_formulario'><input type='text' id='codigomaps' name='codigomaps' value='$codigomaps' class='validate[required] item_normal_formulario'/></div>  
			 			 
			 <div class='item_select_ajuda'>
				<img src='../../images/ajuda.png' onclick=\"$.jGrowl('Siga os passos acima para cadastrar seu site no Google Maps. Caso tenha alguma dúvida acesse http://maps.google.com/support/?hl=pt-BR', { header: 'Google', position:'center', life: 100000});\" />
         	</div>
