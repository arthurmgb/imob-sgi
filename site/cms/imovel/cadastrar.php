...
$cod_imob = isset($_GET["cod_imob"]);

$id_cidade = isset($_GET["id_cidade"]);

$id_bairro = isset($_GET["id_bairro"]);

$endereco = isset($_GET["endereco"]);

$numero = isset($_GET["numero"]);

$complemento = isset($_GET["complemento"]);

$descricao = isset($_GET["descricao"]);
...
* HomeDevice ?m Software propriet?o, N?ivre, cuja c??, 

* redistribui? ou modifica? s?em alguma medida restritos 

* pelo seu criador ou distribuidor.

* Desenvolvido por Fernando Blomer

* HomeDevice e WebDevice s?nomes fansatia de produtos
...
if(isset($_GET['acao'])){
			...
			if (!$result) {
				...
				<script>
		            ...
		            window.alert("InformaÁ„o cadastrada com sucesso!");
...
<?
	...
	echo "<div class='btn_pagina'>
			...
			<div class='btn_listar'>
				...
				<a href='vis.php'><p>Listar im√≥vel</p></a>
	...
	echo "<div class='topo_pagina'>
			...
			<div class='titulo_pagina'> Cadastro de im√≥veis </div>    
			...
			if (empty($_GET['acao'])){	
				...
				echo "<form id='formcadastro' name='formcadastro' method='POST' action='cadastrar.php?acao=cadastrar' enctype='multipart/form-data'>";
  ...
  echo "<div class='formulario'>
  		...
  		<p class='titulo_principal_formulario'> Dados do im??</p>

	 		<div class='titulo_8_formulario'><p>Cod. do im√≥veil</p></div>	 
	...
	<div class='formulario'>	
			...
			<div class='titulo_6_formulario'><p>Tipo de Neg??</p></div>	

			<div class='titulo_6_formulario'><p>Tipo deim??</p></div>

			<div class='titulo_6_formulario'><p>Situa? doim??</p></div>
				...
				<select name='estagio_obra' id='estagio_obra' class='item_2_select_formulario'>";
                	...
                	if($estagio_obra != ''){
							...
							echo" 
								  ...
								  <option value='1'"; if($estagio_obra == '1'){ echo"selected='selected'";} echo">Em Constru?</option>                               

								  <option value='3'"; if($estagio_obra == '3'){ echo"selected='selected'";} echo">LaN?nto</option>                

								  <option value='4'"; if($estagio_obra == '4'){ echo"selected='selected'";} echo">Pr?aN?nto</option> 
						...
						echo"
							  ...
							  <option value='1'>Em Constru?</option>                               

							  <option value='3'>LaN?nto</option>                

							  <option value='4'>Pr?aN?nto</option>
		  ...
		  <div class='item_select_ajuda'>
				...
				<img src='../images/ajuda.png' onclick=\"$.jGrowl('Para que seja mostrada a marca? laN?nto na p?na principal voc?eve selecionar a situa? doim?? como laN?nto.', { header: 'Est?o da Obra', position:'center', life: 100000});\" />
	 ...
	 <div class='formulario'>
	 	...
	 	<p class='titulo_principal_formulario'> Caracter?icas doim??</p>

	 		<div class='titulo_1_formulario'><p>≤ea Total</p></div>	 

			<div class='titulo_1_formulario'><p>≤ea Constru?</p></div>

			<div class='titulo_4_formulario'><p>≤ea de Laser</p></div>

			<div class='titulo_4_formulario'><p>N?de Dormit??s</p></div>
			...
			<div class='item_select_ajuda'>
				...
				<img src='../images/ajuda.png' onclick=\"$.jGrowl('Neste item deve constar a ?a total do terreno.', { header: '≤ea Total', position:'center', life: 100000});\" />
				...
				<select name='area_lazer' id='area_lazer' class='item_2_select_formulario'>";   
                    ...
                    if($area_lazer != ''){					  
							...
							echo"
			                    ...
			                    <option value='2'"; if($area_lazer == '2'){ echo"selected='selected'";} echo">N?option>                                      
			...
			<div class='item_select_ajuda'>
				...
				<img src='../images/ajuda.png' onclick=\"$.jGrowl('Neste item deve ser seleciona caso oim?? possua ?a de laser.', { header: '≤ea de Laser', position:'center', life: 100000});\" />
				...
				<select name='quartos' id='quartos' class='item_1_select_formulario'>";
					...
					if($quartos != ''){
							...
							echo" 
								...
								<option value='1'"; if($quartos == '1'){ echo"selected='selected'";} echo">1 Dormit?? Simple</option> 

								<option value='2'"; if($quartos == '2'){ echo"selected='selected'";} echo">1 Dormit?? com Su?</option>               

								<option value='3'"; if($quartos == '3'){ echo"selected='selected'";} echo">2 Dormit??s Simples</option>                

								<option value='4'"; if($quartos == '4'){ echo"selected='selected'";} echo">2 Dormit??s 1 com Su?</option>                

								<option value='5'"; if($quartos == '5'){ echo"selected='selected'";} echo">3 Dormit??s Simples</option>                

								<option value='6'"; if($quartos == '6'){ echo"selected='selected'";} echo">3 Dormit??s 1 com Su?</option>                

								<option value='7'"; if($quartos == '7'){ echo"selected='selected'";} echo">4 Dormit??s Simples</option>                

								<option value='8'"; if($quartos == '8'){ echo"selected='selected'";} echo">4 Dormit??s 1 com Su?</option>                                      
							...
							echo"
								...
								<option value='1'>1 Dormit?? Simple</option> 

								<option value='2'>1 Dormit?? com Su?</option>               

								<option value='3'>2 Dormit??s Simples</option>                

								<option value='4'>2 Dormit??s 1 com Su?</option>                

								<option value='5'>3 Dormit??s Simples</option>                

								<option value='6'>3 Dormit??s 1 com Su?</option>                

								<option value='7'>4 Dormit??s Simples</option>                

								<option value='8'>4 Dormit??s 1 com Su?</option>";								
	...
	<div class='formulario'>
	 		...
	 		<div class='titulo_6_formulario'><p>N?de salas</p></div>	 

			<div class='titulo_6_formulario'><p>Vagas na Garagem</p></div>

			<div class='titulo_6_formulario'><p>N?de Elevadores</p></div>
		...
		<div class='formulario'>
	 		...
	 		<div class='titulo_6_formulario'><p>N?de andares</p></div>	 

			<div class='titulo_6_formulario'><p>Unidades por andar</p></div>

			<div class='titulo_6_formulario'><p>N?de Banheiros</p></div>
				...
				<select name='banheiro' id='banheiro' class='item_2_select_formulario'>";
					...
					if($banheiro != ''){
							...
							echo" 
								...
								<option value='2'"; if($banheiro == '2'){ echo"selected='selected'";} echo">2 sendo 1 Su?</option>               

								<option value='3'"; if($banheiro == '3'){ echo"selected='selected'";} echo">2</option>                

								<option value='4'"; if($banheiro == '4'){ echo"selected='selected'";} echo">3 sendo 1 Su?</option>                

								<option value='5'"; if($banheiro == '5'){ echo"selected='selected'";} echo">3</option> 

								<option value='6'"; if($banheiro == '6'){ echo"selected='selected'";} echo">4 sendo 1 Su?</option>

								<option value='7'"; if($banheiro == '7'){ echo"selected='selected'";} echo">5</option>

								<option value='8'"; if($banheiro == '8'){ echo"selected='selected'";} echo">5 sendo 1 Su?</option>

								<option value='9'"; if($banheiro == '9'){ echo"selected='selected'";} echo">1 Su?</option>

								<option value='10'"; if($banheiro == '10'){ echo"selected='selected'";} echo">2 sendo 2 Su?s</option>

								<option value='11'"; if($banheiro == '11'){ echo"selected='selected'";} echo">3 sendo 2 Su?s</option>

								<option value='12'"; if($banheiro == '12'){ echo"selected='selected'";} echo">4 sendo 2 Su?s</option>

								<option value='13'"; if($banheiro == '13'){ echo"selected='selected'";} echo">5 sendo 2 Su?s</option>

								<option value='14'"; if($banheiro == '14'){ echo"selected='selected'";} echo">3 sendo 3 Su?s</option>

								<option value='15'"; if($banheiro == '15'){ echo"selected='selected'";} echo">4 sendo 3 Su?s</option>

								<option value='16'"; if($banheiro == '16'){ echo"selected='selected'";} echo">5 sendo 3 Su?s</option>

								<option value='17'"; if($banheiro == '17'){ echo"selected='selected'";} echo">4 sendo 4 Su?s</option>

								<option value='18'"; if($banheiro == '18'){ echo"selected='selected'";} echo">5 sendo 4 Su?s</option>

								<option value='19'"; if($banheiro == '19'){ echo"selected='selected'";} echo">5 sendo 5 Su?s</option>
							...
							echo"
								...
								<option value='2'>2 sendo 1 Su?</option>               

								<option value='3'>2</option>                

								<option value='4'>3 sendo 1 Su?</option>                

								<option value='5'>3</option> 

								<option value='6'>4 sendo 1 Su?</option>

								<option value='7'>5</option>

								<option value='8'>5 sendo 1 Su?</option>

								<option value='9'>1 Su?</option>

								<option value='10'>2 sendo 2 Su?s</option>

								<option value='11'>3 sendo 2 Su?s</option>

								<option value='12'>4 sendo 2 Su?s</option>

								<option value='13'>5 sendo 2 Su?s</option>

								<option value='14'>3 sendo 3 Su?s</option>

								<option value='15'>4 sendo 3 Su?s</option>

								<option value='16'>5 sendo 3 Su?s</option>

								<option value='17'>4 sendo 4 Su?s</option>

								<option value='18'>5 sendo 4 Su?s</option>

								<option value='19'>5 sendo 5 Su?s</option>              
		...
		<div class='formulario'>
			...
			<p class='titulo_principal_formulario'> Endere?doim??</p>
	...
	<div class='formulario'>
	 		...
	 		<div class='titulo_2_formulario'><p>Endere?/p></div>	 
	...
	<div class='formulario'>
	 		...
	 		<div class='titulo_5_formulario'><p>Descri? Completa</p></div>	 	
			...
			<div class='item_select_ajuda'>
				...
				<img src='../images/ajuda.png' onclick=\"$.jGrowl('Preencha este item com uma descri? completa doim?? informado itens que N?st?no formul?o.', { header: 'Descri? Completa', position:'center', life: 100000});\" />
	...
	<div class='formulario'>
		...
		<p class='titulo_principal_formulario'> Configura?s do aN?o</p>

			<div class='titulo_3_formulario'><p>Status do aN?o</p></div>	 

			<div class='titulo_3_formulario'><p>AN?o em destaque</p></div>
				...
				<select name='destaque' id='destaque' class='validate[required] item_2_select_formulario'>";
                	...
                	if($estagio_obra != ''){
						...
						echo"
							...
							<option value='2'"; if($destaque == '2'){ echo"selected='selected'";} echo">N?option>                                      
	...
	echo "<div class='navegacao'><p></p></div>";
			...
			echo" <script> window.alert('Voc??tem permiss?para acessar este item!')</script> 
