...
echo "<div class='btn_pagina'>
			<div class='btn_cadastro'>
				<a href='index.php?id=$id'><p>Cadastar Plantas</p></a>
			</div>    
		</div>";

	echo "<div class='topo_pagina'>
			<div class='titulo_pagina'> Plantas cadastradas </div>    
		</div>";

echo"<div class='vis_fotos'>";
$sql = "SELECT * FROM $banco where id_imovel = $id ORDER BY id DESC";
