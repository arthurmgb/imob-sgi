...
{	$file = $_FILES['photoupload']['tmp_name'];
	...
	elseif (!$error && ($size[0] < 25) || ($size[1] < 25))
	{
		...
		$aux_tipo_imagem = $size['mime'];
            ...
            $diretorio = "../../fotos_acompanhe/";
            $diretorio_g = "../../fotos_acompanhe/g/";
            $diretorio_p = "../../fotos_acompanhe/p/";
...
mysql_query("INSERT INTO $banco (id, id_data, id_imovel, imagem, thumb) VALUES ('null', '$id', '$id_imovel', '/fotos_acompanhe/g/$nome_foto', '/fotos_acompanhe/p/$nome_thumb')");
	}
