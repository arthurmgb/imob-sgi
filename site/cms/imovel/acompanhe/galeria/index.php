...
window.addEvent('load', function() {
	...
	<div class='btn_pagina'>
			<div class='btn_cadastro'>
				<a href='visimg.php?id=<? echo $id;?>&id_imovel=<? echo $id_imovel; ?>'><p>Visulaizar Imagens</p></a>
			</div>    
		</div>
...
<div class="cad_fotos">
<center>
<form action="script.php?id=<? echo $id;?>&id_imovel=<? echo $id_imovel; ?>" method="post" enctype="multipart/form-data" id="form_imagens">
