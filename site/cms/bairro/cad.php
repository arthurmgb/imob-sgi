...
if($_GET['acao'] == "cad"){
			...
			$query = "INSERT INTO $banco (id,nome,id_cidade ) VALUES ('null','".$_POST['nome']."','".$_POST['cidade']."');";
...
if($_GET['acao'] == "alt"){
			...
			$query = "UPDATE $banco SET nome='".$_POST['nome']."', id_cidade='".$_POST['cidade']."' WHERE id='".$_GET['id']."'";
...
<?
	echo "<div class='btn_pagina'>
			<div class='btn_listar'>
				<a href='vis.php'><p>Listar Bairros</p></a>
			</div>    
		</div>";

	echo "<div class='topo_pagina'>
			<div class='titulo_pagina'> Cadastro de Bairros </div>    
		</div>";
     ...
     echo "<div class='formulario'>
			...
			<div class='item_select_formulario'>
				<select name='cidade' id='cidade' class='validate[required] item_normal_formulario'>";
			 ...
			 <div class='item_select_ajuda'>
				<img src='../images/ajuda.png' onclick=\"$.jGrowl('Você deve selecionar a qual cidade pertence este bairro.', { header: 'Cidades', position:'center', life: 100000});\" />
         	</div>
