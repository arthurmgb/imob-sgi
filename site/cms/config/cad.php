...
?> <link rel="stylesheet" type="text/css" href="../css/pagina_config.css"> <?	
	...
	$query = "UPDATE $banco SET tema='".$_POST['tema']."', palavrachave='".$_POST['palavrachave']."'";								
...
<?
	...
	echo "<div class='topo_pagina'>
			<div class='titulo_pagina'>Configurar Site</div>    
		</div>";
	...
	echo "<form id='formcadastro' name='formcadastro' method='POST' action='cad.php?acao=alt' enctype='multipart/form-data'>";		
     ...
     echo "<div class='formulario'>
			...
			<div class='titulo1_formulario'><p>Tema</p></div>
			<div class='item_2_select_formulario'>
				<select name='tema' id='tema' class='validate[required] item_2_select_formulario'>";
						echo"
							<option value='laranja'"; if($tema == 'laranja'){ echo"selected='selected'";} echo">Laranja </option> 
							<option value='azul'"; if($tema == 'azul'){ echo"selected='selected'";} echo">Azul</option> 
							<option value='verde'"; if($tema == 'verde'){ echo"selected='selected'";} echo">Verde</option> 
							<option value='vermelho'"; if($tema == 'vermelho'){ echo"selected='selected'";} echo">Vermelho</option> 
							<option value='amarelo'"; if($tema == 'amarelo'){ echo"selected='selected'";} echo">Amarelo</option>                                      
						";
					echo "</select>
			</div>  
			
			<div class='titulo1_formulario'><p>Palavras Chave</p></div>
			<div class='item1_formulario'><input type='text' id='palavrachave' name='palavrachave' value='$palavrachave' class='validate[required] item_normal_formulario'/></div> 
			 			 
			 <div class='item_select_ajuda'>
				<img src='../images/ajuda.png' onclick=\"$.jGrowl('Informe as palavras chave separadas por virgula.', { header: 'Palavras chave', position:'center', life: 100000});\" />
         	</div>
