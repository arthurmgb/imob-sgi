...
<!-- Mapa google -->
<script src="http://maps.google.com/maps?file=api&v=2&key=<? echo $codigomaps; ?>"
...
<!--imggaleria-->
  ...
  <script type="text/javascript">
    window.addEvent('domready', function(){
      SexyLightbox = new SexyLightBox({color:'black', dir: '../../images'});
    });
  </script>
...
jQuery(document).ready(function() {
    jQuery('#mycarousel_fotos').jcarousel({
        auto: 0,
        wrap: 'last',
...
jQuery(document).ready(function() {
    jQuery('#mycarousel_plantas').jcarousel({
        auto: 0,
        wrap: 'last',
        initCallback: mycarousel_initCallback
    });
...
jQuery(document).ready(function() {
    jQuery('#mycarousel_acompanhe').jcarousel({
        auto: 0,
        wrap: 'last',
        initCallback: mycarousel_initCallback
    });
...
<div id="bg_descicao">
    	...
    	<div class="topo">
            ...
            <div class="menu_ul">
    			<ul class="lavaLamp">
                    ...
                    <li class="menu_clas <? if($_GET["negocio"] == 'comprar'){echo 'current';}?> " >            
	                    <a href="../../imovel/index/?negocio=comprar">Comprar</a>            
                    </li>      
                    <li class="menu_clas <? if($_GET["negocio"] == 'alugar'){echo 'current';}?>" >            
                    	<a href="../../imovel/index/?negocio=alugar">Alugar</a>            
                    </li>  
                    <li class="menu_clas <? if($_GET["negocio"] == ''){echo 'current';}?>" >            
    ...
    <div id="conteudo_descricao">            
            ...
            <div class="mais_imoveis_descricao">
            	<? include("dados.php"); ?>
                 </div>
