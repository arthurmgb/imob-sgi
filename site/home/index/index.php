...
<div id="bg">
    ...
    <div id="conteudo">            
            ...
            <div class="banner_lateral">
            	<div class="banner_lateral_financiamento">
					<a href="../../simuladores/index/"><img src="../../temas/<? echo $tema; ?>/images/fundo_financiamento.png" /></a>
            	</div>
                <div class="banner_lateral_indique">
					<a href="../../contato/indique/"><img src="../../temas/<? echo $tema; ?>/images/fundo_indique.png" /></a>
            	</div>
                <div class="banner_lateral_empresa">
					<a href="../../empresa/index/"><img src="../../temas/<? echo $tema; ?>/images/fundo_empresa.png" /></a>
            	</div>
            </div><!-- Banner Lateral -->  
            ...
            <div class="mais_imoveis">
                 <div class="mais_imoveis_titulo">
                        Mais Imóveis
                 </div> 
                 <div class="mais_imoveis_itens">
                 	<? include("maisimoveis.php"); ?>
                 </div>
         ...
         <div class="rodape">
            <div class="rodape_conteudo">
                ...
                <a href="http://mdhospeda.com/" target="_blank">
<img src="https://mdhospeda.com/wp-content/uploads/2015/07/novo-logo.png" /></a>
                </div>
