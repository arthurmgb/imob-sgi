    ...
    <section class="content">
        <div class="row">
            <div class="col-xs-12 flex-col-center">
                ...
                <div class="item-flex">
                    <a style="font-size: 22px; padding: 15px 30px; max-width: 100%; white-space: normal; width: 640px;" href="<?php echo BASE_URL; ?>relatorios/clientes" name="button-toggle-rel" value="button-toggle-rel" class="btn btn-lg btn-primary">
                ...
                <div class="item-flex">
                    <a style="font-size: 22px; padding: 15px 30px; max-width: 100%; white-space: normal; width: 640px;" href="<?php echo BASE_URL; ?>relatorios/clientesDataPag" name="button-toggle-rel" value="button-toggle-rel" class="btn btn-lg btn-success">
