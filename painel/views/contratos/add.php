				...
				<form role="form" method="POST">
					<div class="box-body">
						<div class="form-group">
							...
							<input name="cod_imovel" class="form-control" id="busca" value="<?php echo (!empty($imovel['referencia'])) ? $imovel['referencia']:'';?>">
						</div>
						<div class="form-group">
						...
						<div class="row">
							<div class="col-xs-5 col-md-4">
								<div class="form-group">
									...
									<input type="text" name="cod_inquilino" onkeyup="pegarFiadoresPorCodInquilino(this)" class="form-control">
								</div>
							</div>
