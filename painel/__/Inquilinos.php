...
class Inquilinos extends Model {
	...
	public function getList($offset, $limit, $filtros=array()){
		...
		FROM inquilinos inq LEFT JOIN imoveis imo ON inq.cod_imovel = imo.referencia WHERE '1'='1' ".implode(' OR ', $where)." LIMIT $offset, $limit";
	...
	public function getIptu($limit) {
		$array = array();
		$sql = "SELECT inq.*, imo.endereco, imo.bairro, imo.iptu FROM inquilinos inq LEFT JOIN imoveis imo ON inq.cod_imovel = imo.referencia WHERE imo.iptu = '1' LIMIT $limit";
