...
class Imoveis extends Model {
	...
	public function disponiveis($limit) {
		$array = array();
		$sql = "SELECT * FROM imoveis WHERE status = '1' and finalidade = '1' ORDER BY data_cad DESC LIMIT $limit";
	...
	*/
	...
	public function qtdImoveisAtivos() {
		...
		$sql = "SELECT COUNT(*) as c FROM imoveis WHERE status = '1'";
		$sql = $this->db->query($sql);
	...
	public function updateImovel($codigo_proprietario, $endereco, $bairro, $cidade, $uf, $cep, $type, $finalidade, $valor, $iptu, 
            $reajuste, $comissao, $status, $dormitorios, $suites, $banheiros, $garagem, $tamanho, $outros, $fotos, $id){	
